...
include_once(__DIR__ . "/functions/class.php");
include_once(__DIR__ . "/functions/feedback.php");
include_once(__DIR__ . "/functions/curriculum.php");
include_once(__DIR__ . "/functions/certificate.php");
include_once(__DIR__ . "/components/user.php");
include_once(__DIR__ . "/components/index.php");
